...
insert  into `sys_config`(`variable`,`value`,`set_time`,`set_by`) values ('diagnostics.allow_i_s_tables','OFF','2022-11-14 11:37:33',NULL),('diagnostics.include_raw','OFF','2022-11-14 11:37:33',NULL),('ps_thread_trx_info.max_length','65535','2022-11-14 11:37:33',NULL),('statement_performance_analyzer.limit','100','2022-11-14 11:37:33',NULL),('statement_performance_analyzer.view',NULL,'2022-11-14 11:37:33',NULL),('statement_truncate_len','64','2022-11-14 11:37:33',NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `version` (`sys_version`,`mysql_version`) AS select '2.1.1' AS `sys_version`,version() AS `mysql_version` */;
